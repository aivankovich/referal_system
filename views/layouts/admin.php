    ...
    <div class="row">
        ...
        <nav class="nav-menu col-lg-8 offset-lg-1 mobile-hidden">
            <ul class="nav-menu_list">
                <li class="nav-item">
                    <a href="<?=Url::toRoute(['solutions/index'])?>" class="nav-item_link">Решения</a>
                </li>
                <li class="nav-item">
                    <a href="<?=Url::toRoute(['site/about'])?>" class="nav-item_link">Информация</a>
                </li>
                <li class="nav-item">
                    <a href="<?=Url::toRoute(['user/index'])?>" class="nav-item_link">Пользователи</a>
                </li>
            </ul>
            <ul class="profile-list">
                <li class="profile-item">
                    <a href="<?=Url::toRoute(['dealer/profile'])?>" class="avt avt_login">Ваш ID/</a>
                    <?= Html::a("Выход", ['site/logout'], ['data' => ['method' => 'post'], 'class' => 'avt avt_login']);?>
                </li>
                <li class="profile-item">
                    <a href="<?=Url::toRoute(['dealer/profile'])?>" class="reg reg_login"><?=Yii::$app->user->getId()?></a>
                </li>
            </ul>
        </nav>
...
<div class="mobile-menu desctop-hidden container">
    <div class="row">
        ...
        <a href="<?=Url::toRoute(['user/index'])?>" class="button-custom col-12 menu-btn_inner">Пользователи</a>
        <a href="<?=Url::toRoute(['site/about'])?>" class="button-custom col-12 menu-btn_inner">Информация</a>
        <a href="javascript:void(0);" class="button-custom col-12 menu-btn_inner"> </a>
    </div>
</div>
    <?= $content ?>
<footer class="footer">
            ...
            <div class="col-lg-3 mobile-hidden offset-lg-1">
                <ul class="footer-nav">
                    <li class="footer-nav_item">
                        <a href="<?=Url::toRoute(['solutions/index'])?>" class="footer-title">Решения</a>
                    </li>
                    <li class="footer-nav_item">
                        <a href="<?=Url::toRoute(['site/about'])?>" class="footer-title">Информация</a>
                    </li>
                    <li class="footer-nav_item">
                        <a href="<?=Url::toRoute(['user/index'])?>" class="footer-title">Пользователи</a>
                    </li>
                </ul>
            </div>
