        ...
        <nav class="nav-menu col-lg-8 offset-lg-1 mobile-hidden">
            ...
            <ul class="profile-list">
                <li class="profile-item">
                    <a href="<?= Url::toRoute(['site/login']) ?>" class="avt">Вход</a>
                </li>
                <li class="profile-item">
                    <a href="<?= Url::toRoute(['site/signup']) ?>" class="reg">Регистрация</a>
                </li>
            </ul>
        </nav>
...
<div class="mobile-menu desctop-hidden container">
    <div class="row">
        ...
        <a href="<?=Url::toRoute(['site/login'])?>" class="col-6 lined1">Войти</a>
        <a href="<?=Url::toRoute(['site/signup'])?>" class="lined2 col-6">Регистрация</a>
