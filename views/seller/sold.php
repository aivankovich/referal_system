...
$this->title = 'Проданные заявки';
?>
<main class="new-manager_page sold-manager_page">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="table-container">
                    ...
                    <div class="table-container_information">
                        <ul class="legend-list">
                            ...
                            <li class="legend-item">
                                <p class="legend-item_desc">Подтвердить продажу</p>
                            </li>
                        </ul>
                        <div class="table-slider">
                            <?php foreach ($orders as $order) { ?>
                            <form method="post" data-id="<?=$order->id?>"  class="table-slider_item seller-sold-order-item_form">
                                    ...
                                    <li class="inner-item full-width">
                                        ...
                                        <div class="table-select_wrap mdi mdi-chevron-down status_blue_wrap">
                                            <select name="status" class="table-select_status status_blue">
                                                ...
                                                <option selected value="4">Проданная</option>
                                            </select>
                                        </div>
                                    </li>
                                    <li class="inner-item full-width">
                                        <span class="desctop-hidden">Подтвердить продажу</span>
                                        <button data-id="<?=$order->id?>" type="button" class="order-approve-button table-button <?=($order->approved == true ? 'hidden' : '')?>">Подтвердить</button>
                                        <button data-id="<?=$order->id?>" type="button" class="order-abort-button table-button <?=($order->approved == true ? '' : 'hidden')?>">Отмена</button>
                                    </li>
                                </ul>
                            </form>
                            <?php } ?>
