...
<main class="report-manager_page">
    <div class="container">
        <div class="row justify-content-center ">
            <div class="col-lg-10 report-date-cont">
                ...
                <div class="date-wrap">
                    ...
                    <input type="text" class="hidden-date">
                </div>
            </div>
            <div class="col-lg-12 report-diller_list__wrap">
                <ul class="report-diller_list">
                    <li class="report-diller_item report-diller_item__first mobile-hidden">
                        <p class="report-desc  report-desc_first_manager">Решение</p>
                    ...
                    <li class="report-diller_item">
                        <p class="report-desc  report-desc_first_manager"><span class="desctop-hidden">Решение</span> Incarnet Vi4 </p>
                        <p class="report-desc   report-desc_second_manager"><span class="desctop-hidden">Принятые</span> 3</p>
                        <p class="report-desc   report-desc_third_manager"><span class="desctop-hidden">Завсишие</span> 2</p>
                        <p class="report-desc   report-desc_fourth_manager"><span class="desctop-hidden">Проданные </span> 3</p>
                        <p class="report-desc   report-desc_fifth_manager"><span class="desctop-hidden">Отказные</span> 4</p>
                    </li>
                    <li class="report-diller_item">
                        <p class="report-desc  report-desc_first_manager"><span class="desctop-hidden">Решение</span> Incarnet Vi4 </p>
                        <p class="report-desc   report-desc_second_manager"><span class="desctop-hidden">Принятые</span> 3</p>
                    ...
                    <li class="report-diller_item report-diller_item__all">
                        <p class="report-desc  report-desc_first_manager">Всего</p>
                        <p class="report-desc   report-desc_second_manager"><span class="desctop-hidden">Принятые</span> 32</p>
                        <p class="report-desc   report-desc_third_manager"><span class="desctop-hidden">Проданные</span> 21</p>
                        <p class="report-desc   report-desc_fourth_manager"><span class="desctop-hidden">Зависшие</span> 11</p>
                        <p class="report-desc   report-desc_fifth_manager"><span class="desctop-hidden">Отказные</span> 12</p>
                    </li>
                </ul>
            </div>
        </div>
