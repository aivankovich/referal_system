...
$this->title = 'Зависшие заявки';
?>
<main class="new-manager_page hung-manager_page">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="table-container">
                    ...
                    <div class="table-container_information">
                        ...
                        <div class="table-slider">
                            ...
                            <form method="post" class="table-slider_item manager-hung-order-item_form">
                                <ul class="table-inner_list">
                                        ...
                                        <div class="table-select_wrap mdi mdi-chevron-down">
                                            <select name="solution" class="table-select_model">
                                                <?php foreach ($solutions as $solution){ ?>
                                                    <option <?=($order->solution == $solution->id ? 'selected' : '')?> value="<?=$solution->id?>"><?=$solution->name?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </li>
                                    ...
                                    <li class="inner-item full-width">
                                        <div class="date-wrap date-wrap_table">
                                            ...
                                            <input name="restart_date" type="text" value="<?=($order->restart_date ? date("d.m.Y", strtotime($order->restart_date)) : 'Не указано')?>" class="hidden-date">
                                        </div>
                                    </li>
                                </ul>
                            </form>
