...
<?php $form = ActiveForm::begin([
    ...
    <fieldset class="col-lg-4 offset-lg-2">
        ...
        <div class="select-cont">
            <?= $form->field($model, 'registration_ciity')->textInput(['class' => 'input-custom', 'placeholder' => 'Город']) ?>
        </div>
        <div class="select-cont">
    ...
    <fieldset class="col-lg-4">
        ...
        <div class="select-cont">
            <?= $form->field($model, 'living_city')->textInput(['class' => 'input-custom', 'placeholder' => 'Город']) ?>
        </div>
        <div class="select-cont">
